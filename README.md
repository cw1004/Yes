...
> 이 저장소에는 두 개의 파이프라인이 들어 있습니다.
> - **INDIA 2030** (아래 문서): 100부작 숏폼 시리즈 자동 생성
> - **SHOPREEL** ([README.shopreel.md](README.shopreel.md)): 소셜커머스 인기상품을
>   실시간 수집 → 제휴 링크 → 자동 영상 → SNS 자동 업로드 → 수익 추적
